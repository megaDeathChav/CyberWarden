...
export function SidebarWithLogo() {
  ...
  return (
    <Card variant="gradient" className="rounded-none h-screen w-7/8 max-w-[20rem] shadow-2xl bg-gradient-to-t from-blue-100 via-blue-200 to-blue-100 shadow-black dark:bg-gradient-to-b dark:from-gray-900 dark:via-gray-700 dark:to-gray-900">
